...
/***/ function(module, exports, __webpack_require__) {
	...
	var Games = React.createClass({
		...
		loadDate: function loadDate() {
			...
			var year = self.state.date.substr(0, 4);
			var month = self.state.date.substr(5, 2);
			var day = self.state.date.substr(8, 2);
		...
		handleGetGamesClick: function handleGetGamesClick(event) {
			console.log(this.state.date);
			this.loadDate();
		},
		getGameDetail: function getGameDetail(game) {
			console.log(game);
			var reducer = function reducer() {
				var state = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
				var action = arguments[1];
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'appBox container' },
				React.createElement(
					'div',
					{ className: 'row' },
					React.createElement(
						'div',
						{ className: 'dates col-md-3' },
						React.createElement('input', { className: 'form-control input-md',
							type: 'date',
							name: 'date',
						...
						React.createElement(
							...
							{ className: 'btn btn-default',
								onClick: this.handleGetGamesClick },
							'Get Games'
						)
					)
				),
				React.createElement(
					'div',
					{ className: 'row appRow' },
					this.state.gamesInfo.map(function (game, i) {
						var homeWin = "";
						var awayWin = "";
						if (!game.linescore) {
							return React.createElement(
								'div',
								{ className: 'game col-md-3 text-center', key: i },
								React.createElement(
									'p',
									null,
									game
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'h2',
							null,
							this.state.gameDetail.home_team_name
						),
						React.createElement(
							'h3',
							null,
							this.state.gameDetail.linescore.r.home
						)
					),
					React.createElement(
						'div',
						...
						React.createElement(
							'h3',
							null,
							this.state.gameDetail.linescore.r.away
						)
					)
				),
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							null,
							'Away: ',
							this.state.gameDetail.linescore.e.away
						),
						React.createElement(
							'p',
							null,
							'Home: ',
							this.state.gameDetail.linescore.e.home
						),
						React.createElement(
							'h4',
							null,
						...
						React.createElement(
							...
							null,
							'Away: ',
							this.state.gameDetail.linescore.h.away
						),
						React.createElement(
							'p',
							null,
							'Home: ',
							this.state.gameDetail.linescore.h.home
						)
					),
					React.createElement(
						'div',
						...
						React.createElement(
							...
							null,
							'Away: ',
							this.state.gameDetail.linescore.hr.away
						),
						React.createElement(
							'p',
							null,
							'Home: ',
							this.state.gameDetail.linescore.hr.home
						),
						React.createElement(
							'h4',
							null,
					...
					React.createElement(
						...
						React.createElement(
							...
							null,
							'Away: ',
							this.state.gameDetail.linescore.sb.away
						),
						React.createElement(
							'p',
							null,
							'Home: ',
							this.state.gameDetail.linescore.sb.home
						),
						React.createElement(
							'h4',
							null,
						...
						React.createElement(
							...
							null,
							'Away: ',
							this.state.gameDetail.linescore.so.away
						),
						React.createElement(
							'p',
							null,
							'Home: ',
							this.state.gameDetail.linescore.so.home
						)
					)
				)
			);
	...
	ReactDOM.render(React.createElement(
		...
		React.createElement(_reactRouter.Route, { path: '/', component: Games }),
		React.createElement(_reactRouter.Route, { path: '/details', component: Details })
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(103)(global || window || this);
